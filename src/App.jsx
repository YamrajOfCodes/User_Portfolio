      ...
      <Layout>
        ...
        <section className='w-full h-auto flex mt-5 sm:mt-20' id='home'>
          <div className="left w-full lg:w-[56%] h-full text-white gap-2 flex flex-col justify-start items-center">
            <h1 className='text-7xl sm:text-9xl md:text-[10rem] lg:text-[8rem] xl:text-[9rem] 2xl:text-[11rem]   text-center font-bold'>PRODUCT DESIGNER</h1>
            <h2 className='text-4xl sm:text-6xl md:text-[5rem] lg:text-[3.8rem] xl:text-[4.5rem] 2xl:text-[5.5rem] 3xl:text-[7rem]  font-bold bg-linear-to-r from-gradient-start via-gradient-mid to-gradient-end bg-clip-text text-transparent'>CRISTIAN MUNOZ</h2>
        ...
        <div className="counterSection mt-20 bg-bg-primary w-[90%] mx-auto sm:w-full lg:w-full md:mt-40 
                flex flex-col sm:flex-row justify-evenly items-center text-white border border-Border 
                rounded-2xl py-10 lg:py-15 gap-10 sm:gap-20">
          ...
          {portfolioFigures.map((item, index) => (
            <div key={index} className="flex items-center gap-5">
              ...
              <div className="flex flex-col items-center justify-center px-5 text-[rgba(200,254,199,1)]">
                <h3 className="text-5xl xl:text-7xl 2xl:text-9xl font-bold flex items-center">

                  {index !== 0 && (
                    <ChevronRight className="size-10 lg:size-20 mr-3" />
                  )}
                ...
                {item.desc
                  ...
                  .filter(Boolean)
                  .map((line, i) => (
                    <p key={i} className="font-bold text-sm lg:text-xl xl:text-2xl text-center">
                      {line}
                    </p>
                  ))}
              </div>
        ...
        {/* These section is From Page 1 */}


        {/* <section className="w-[120%] h-auto mt-26 -ml-10 md:-ml-20 xl:-ml-32 " id='about'>
          <div className="relative rounded-xl  w-full flex justify-center items-center overflow-hidden h-full">
            ...
            <div className="relative px-12 py-16 text-center ">
              ...
              <p className="text-white leading-relaxed mb-8 max-w-5xl mx-auto text-lg md:text-2xl xl:text-3xl">
          ...
          <div className="relative w-full">
            ...
            <div className="bg-purple-400 rounded-xl p-2  sm:p-10 md:p-12 pl-48 sm:pl-60 md:pl-72 lg:pl-96  min-h-[200px] md:min-h-[240px] lg:min-h-[280px] flex items-center">
              <div className="text-white text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed ">
                <p className='text-sm sm:text-xl lg:text-2xl  -ml-8 sm:ml-0'>
